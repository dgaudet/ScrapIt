...
- (NSArray *)setupTableData {
    ...
    [row0 setLabel1Color:[ThemeHelper mainTextColorForCreditsView]];
    [row0 setLabel2Color:[ThemeHelper subTextColorForCreditsView]];
    ...
    [row1 setLabel1Color:[ThemeHelper mainTextColorForCreditsView]];
    [row1 setLabel2Color:[ThemeHelper subTextColorForCreditsView]];
    ...
    [row2 setLabel1Color:[ThemeHelper mainTextColorForCreditsView]];
    [row2 setLabel2Color:[ThemeHelper subTextColorForCreditsView]];
    ...
    [row3 setLabel1Color:[ThemeHelper mainTextColorForCreditsView]];
    [row3 setLabel2Color:[ThemeHelper subTextColorForCreditsView]];
    ...
    [row4 setLabel1Color:[ThemeHelper mainTextColorForCreditsView]];
    [row4 setLabel2Color:[ThemeHelper subTextColorForCreditsView]];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    lineView.backgroundColor = [ThemeHelper rowSeparatorColorForCreditsView];
